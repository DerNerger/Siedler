...
#include "../../Sourcecode/View/Icon.h"
...
QT_MOC_LITERAL(1, 5, 16), // "showBuildingInfo"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 9), // "Building*"
QT_MOC_LITERAL(4, 33, 8) // "building"

    },
    "Icon\0showBuildingInfo\0\0Building*\0"
    "building"
};
...
void Icon::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->showBuildingInfo((*reinterpret_cast< Building*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Icon::*_t)(Building * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Icon::showBuildingInfo)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Icon::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_Icon.data,
...
// SIGNAL 0
void Icon::showBuildingInfo(Building * _t1)
{
