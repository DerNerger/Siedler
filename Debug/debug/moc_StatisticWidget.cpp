...
#include "../../Sourcecode/View/StatisticWidget.h"
...
struct qt_meta_stringdata_StatisticWidget_t {
    QByteArrayData data[1];
    char stringdata0[16];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_StatisticWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_StatisticWidget_t qt_meta_stringdata_StatisticWidget = {
    {
QT_MOC_LITERAL(0, 0, 15) // "StatisticWidget"
...
const QMetaObject StatisticWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_StatisticWidget.data,
      qt_meta_data_StatisticWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *StatisticWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_StatisticWidget.stringdata0))
